...
use rp235x_hal::{self, pac, prelude::*, Timer};
...
static ALARM0: Mutex<RefCell<Option<Alarm0<hal::timer::CopyableTimer0>>>> = Mutex::new(RefCell::new(None));
static TIMER: Mutex<RefCell<Option<Timer<hal::timer::CopyableTimer0>>>> = Mutex::new(RefCell::new(None));
