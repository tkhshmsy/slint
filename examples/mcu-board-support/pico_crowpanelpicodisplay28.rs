...
pub fn init() {
    ...
    let mut sd_cs = pins.gpio22.into_push_pull_output();
    sd_cs.set_high().unwrap();
    let mut backlight_pwm = pins.gpio18.into_push_pull_output();
    backlight_pwm.set_high().unwrap();
