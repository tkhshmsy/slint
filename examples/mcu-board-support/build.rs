...
fn main() -> std::io::Result<()> {
    ...
    cfg_if::cfg_if! {
        ...
        } else if #[cfg(feature = "pico-crowpanelpicodisplay28")] {
            board_config_path = Some([env!("CARGO_MANIFEST_DIR"), "pico_crowpanelpicodisplay28", "board_config.toml"].iter().collect());
        }
    }
